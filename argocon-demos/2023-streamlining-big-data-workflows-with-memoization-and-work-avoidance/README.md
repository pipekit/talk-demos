...
## The talk
The talk recording [can be found here](https://www.youtube.com/watch?v=29r3wZHP2eU).

The slide deck for this talk can be found [here](assets/slide-deck.pdf).

## Example Workflow
An example workflow that has a toy memoization and use of an artifacts can be found [here](workflow/example.yaml).
